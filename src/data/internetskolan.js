export const internetskolan = {
  ...
  github: "",
  liveDemo: "https://saschjo.github.io/internetskolan/",
  blocks: [
    {
      type: "h1",
    ...
    {
      type: "text",
      content: "The project iteratively followed the five user-centered phases of the Design Thinking framework: Empathize, Define, Ideate, Prototype and Test.",
    },
    {
      type: "h2",
    ...
    {
      type: "text",
      content: "Due to the Covid-19 pandemic and the target group's limited digital literacy, direct physical meetings were not possible. Our user research instead relied on already existing secondary data — statistics, reports, and case studies — as well as previous academic work on digital exclusion and an analysis of existing solutions. We also conducted two surveys to gain primary insights into the users, their needs and their perceptions of the internet, digital solutions and digital exclusion.",
    },
    {
      type: "h3",
    ...
    {
      type: "text",
      content: "Due to data limitations, we narrowed our primary target audience to seniors above the age of 65 who possess some digital familiarity but require help with the fundamentals of the internet. However, the solution remains highly relevant for a secondary target audience of people with disabilities with similar needs as the elderly or any beginner navigating the digital landscape.",
    },
    {
      type: "image",
      url: "/images/internetskolan-8.jpg",
    },
    {
      type: "image",
      url: "/images/internetskolan-9.jpg",
    },
    {
      type: "image",
      url: "/images/internetskolan-10.jpg",
      caption: "Primary personas Agda and Nahom, and secondary persona Anna.",
    },
    {
      type: "h3",
      content: "Insights",
    ...
    {
      type: "quote",
      content: "Seniors above the age of 65 need to learn more about the internet to become, and dare to be, more digitally involved.",
      caption: "The project's Point-of-View (POV).",
    },
    {
      type: "quote",
      content: "How might we educate seniors about the internet in an engaging and inspiring way?",
    ...
    {
      type: "text",
      content: "We iterated on the solution three times based on user testing with seniors, relatives of digitally excluded elders, representatives from SeniorNet, and our stakeholders. Feedback across all prototypes was overwhelmingly positive, with minor suggestions fueling the continuous refinement of the core concept and UI.",
    },
    {
      type: "h3",
    ...
    },
    {
      type: "gallery-row",
      images: [
        { url: "/images/internetskolan-lofi-1.jpg" },
        { url: "/images/internetskolan-lofi-2.jpg" },
        { url: "/images/internetskolan-lofi-3.jpg" },
        { url: "/images/internetskolan-lofi-4.jpg" },
      ],
      caption: "The lo-fi prototype exploring the concept and structure of a lesson-based website.",
    },
    {
      type: "image",
      url: "/images/internetskolan-13.png",
      caption: "Look-and-Feel profiles used to test aesthetic preferences. Frames 2, 4, 5, and 6 were the most well-received by users.",
    },
    {
      type: "h3",
    ...
    },
    {
      type: "gallery-row",
      images: [
        { url: "/images/internetskolan-hifi-1.jpg" },
        { url: "/images/internetskolan-hifi-2.jpg" },
        { url: "/images/internetskolan-hifi-3.jpg" },
        { url: "/images/internetskolan-hifi-4.jpg" },
      ],
      caption: "The first hi-fi iteration where the Purple Line concept was initially proposed.",
    },
    {
      type: "gallery-row",
      images: [
        { url: "/images/internetskolan-hifi-11.jpg" },
        { url: "/images/internetskolan-hifi-12.jpg" },
        { url: "/images/internetskolan-hifi-13.jpg" },
        { url: "/images/internetskolan-hifi-14.jpg" },
        { url: "/images/internetskolan-hifi-15.jpg" },
      ],
      caption: "The second hi-fi iteration where the Purple Line concept was removed, a blue theme was applied, and the Link Bank (Länkbanken) was added.",
    },
    {
      type: "h3",
    ...
    },
    {
      type: "gallery-row",
      images: [
        { url: "/images/internetskolan-prototyp-1.png" },
        { url: "/images/internetskolan-prototyp-2.png" },
        { url: "/images/internetskolan-prototyp-3.png" },
        { url: "/images/internetskolan-prototyp-4.png" },
    ...
    },
    {
      ...
      caption: "Original persona illustrations of Agda and Nahom by a team member (left), which I later iterated upon (right).",
    },
    {
      type: "image",
      url: "/images/illustrationer.jpg",
      caption: "Final illustrations created by me for the interactive prototype.",
    },
    {
      type: "h1",
    ...
    {
      type: "text",
      content: "Click the button below to explore the final prototype (Note: The prototype is currently only optimized for 13-inch screens):",
    },
    {
      type: "button",
    ...
    {
      type: "text",
      content: "The Internet School is organized into three main sections: Lessons (Lektioner), the Link Bank (Länkbanken), and the Dictionary (Lexikon).",
    },
    {
      type: "h2",
      content: "Lessons",
    ...
    {
      type: "text",
      content: "The educational lessons focus on building mental models of the internet by explaining both broad and specific digital topics in an accessible way. Prototype examples include “Lesson 1: How does the Internet work?” (Lektion 1: Hur fungerar internet?) and “Lesson 2: Online Safety” (Lektion 2: Faror på internet)."
    },
    {
      type: "image",
      url: "/images/lektion1.gif",
    },
    {
      type: "image",
    ...
    {
      type: "text",
      content: "The practical lessons follow a step-by-step format to help seniors perform specific digital tasks easily and safely, encouraging active interaction with the internet. An example in the prototype is “Lesson 3: Creating an E-mail Account” (Lektion 3: Skapa ett e-postkonto).",
    },
    {
      type: "image",
    ...
    },
    {
      type: "text",
      content:
        "The Internet School should be accessible to be used by the elderly and others with similar needs. This includes, for example, high color contrasts in the color scheme, educational and simple language, short text passages, and clear, guiding and confirming interaction elements.",
    },
    {
      type: "text",
      content: "We have also adapted the website based on the secondary target group. Language selection and text-to-speech are available as options in the menu bar. The language choices should be Swedish, English, Arabic, Tigrinya and Somali; common languages ​​in the Spånga-Tensta district area. The option “Text size” is also available in the menu bar as readability is very individual."
    },
    {
      type: "text",
      content: "The Internet School should also be able to be used on all digital devices, and have different modes for different needs of support or digital literacy."
    },
    {
      type: "image",
    ...
    {
      type: "text",
      content: "User testing consistently showed a high level of interest and a genuine want and need for the platform. Our stakeholders stated that our work and the solution exceeded all of their expectations. They emphasized the project's alignment with real-world needs, and expressed intent to discuss the project with decision-makers for potential future implementation.",
    },
    {
      type: "text",
      content: "Based on such reactions, we believe that the project successfully achieved its mission; that older people can independently learn about the internet, dare to be more digitally involved and be included in digital contexts. The solution can thus counteract digital exclusion."
    },
    {
      type: "h1",
    ...
    {
      type: "text",
      content: "I am extremely satisfied with the project, the iterative design process and the research-backed design choices that led to this elaborate solution. This was one of the most rewarding design experiences I've had, thanks to a strong team, stakeholder engagement and a detailed plan!",
    },
    {
      type: "text",
      content: "I bring the following lessons with me from working with The Internet School:",
    },
    {
      type: "list",
      style: "ul",
