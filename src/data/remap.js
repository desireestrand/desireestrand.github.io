export const remap = {
  ...
  blocks: [
    ...
    {
      type: "text",
      content: "Our mission was to visualize Re:map through a comprehensive design brief and brand identity, including a moodboard, logo, color palette, typography, visual style, slogan, mock-ups, and personas. The project was executed in three distinct phases: initial development of two competing visual directions, refinement of the selected concept, and a final presentation featuring a concept film and a formal pitch.",
    },
    {
      type: "h2",
      content: "My Role",
    ...
    {
      type: "text",
      content: "In this project, I served as a Core Graphic Designer, co-defining the brand identity with my team and creating layouts for various presentation and documentation materials. Specific contributions and deliverables are highlighted throughout the design process section.",
    },
    {
      type: "h1",
    ...
    {
      type: "h2",
      content: "Phase 1: Concept Sketching",
    },
    {
      type: "text",
      content:
    ...
    {
      type: "image",
      url: "/images/remap-konceptskiss.jpg",
      caption: "The final concept sketch.",
    },
    {
      type: "h2",
      content: "Phase 3: Concept Film & Pitch",
    },
    {
      type: "text",
      content:
    ...
    },
    {
      type: "gallery-2col",
      images: [
        { url: "/images/remap-5-1.jpg" },
        { url: "/images/remap-5-2.jpg" },
        { url: "/images/remap-5-3.jpg" },
        { url: "/images/remap-5-4.jpg" },
      ],
      caption: "Collages that I illustrated for the concept film.",
    },
    {
      type: "text",
      content:
    ...
    {
      type: "image",
      url: "/images/remap-16.jpg",
      caption: "The Re:map moodboard.",
    },
    {
      type: "h3",
      content: "Logo",
    ...
    {
      type: "image",
      url: "/images/remap-logotyper.jpg",
      caption: "Re:map logos and brand marks.",
    },
    {
      type: "h3",
      content: "Patterns",
    ...
    {
      type: "image",
      url: "/images/remap-monster.jpg",
      caption: "Custom Re:map patterns.",
    },
    {
      type: "h3",
    ...
    {
      type: "image",
      url: "/images/remap-fargpalett.jpg",
      caption: "The Re:map color palette.",
    },
    {
      type: "h3",
      content: "Typography",
    ...
    {
      type: "image",
      url: "/images/remap-typsnitt.jpg",
      caption: "Headline, body, and accent typography for Re:map.",
    },
    {
      type: "image",
    ...
    {
      type: "image",
      url: "/images/remap-19.png",
      caption: "Re:map's art direction and visual style.",
    },
    {
      type: "h3",
      content: "Slogan",
    ...
    {
      type: "image",
      url: "/images/remap-slogan.jpg",
      caption: "The Re:map slogan.",
    },
    {
      type: "h3",
      content: "Visualizations & Mock-ups",
    },
    {
      type: "text",
      content:
    ...
    {
      type: "image",
      url: "/images/remap-25.jpg",
      caption: "Promotional poster for Re:map, designed by me.",
    },
    {
      type: "gallery-2col",
      images: [
        { url: "/images/remap-23.jpg" },
        { url: "/images/remap-24.jpg" },
    ...
    {
      type: "image",
      url: "/images/remap-21.jpg",
    },
    {
      type: "image",
      url: "/images/remap-22.jpg",
      caption: "Primary and secondary target audience personas for Re:map.",
    },
    {
      type: "h1",
      content: "Results",
    ...
    },
    {
      type: "text",
      content:
        "The following lessons are what I bring with me from the Re:map project:",
    },
    {
      type: "list",
      style: "ul",
      items: [
        "Establishing a collective foundation and a positive mindset early on creates a healthy work environment where everyone can participate and stay engaged, driving both efficiency and precision in the project.",
        "With continuous check-ins where everyone attends, close collaboration, and clear communication and planning, a team can operate fluidly without rigid roles, tackling individual tasks based on collective needs. This requires shared goals, expectations and high discipline.",
        "Dare to embrace maximalism in visual design.",
      ],
    },
  ],
};
